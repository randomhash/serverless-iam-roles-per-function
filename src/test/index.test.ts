...
describe('plugin tests', function (this: any) {
  ...
  describe('defaultInherit not set', () => {
    ...
    describe('#validateStatements', () => {
      ...
      it('should not throw error if no awsPackage plugin', () => {
        const indx = serverless.pluginManager.plugins.findIndex(
          (p: any) => p.constructor.name === 'AwsPackage'
        );
    ...
    describe('#createRolesPerFunction', () => {
      it('should create role per function', () => {
        ...
        // it is not more dependent on the global role! inversigate
        // assert.isTrue(
